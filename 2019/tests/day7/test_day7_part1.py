...
@pytest.mark.parametrize("program, phase_settings, expected",
                         [([3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0], [4, 3, 2, 1, 0], 43210),
                          ...
                          ([3, 31, 3, 32, 1002, 32, 10, 32, 1001, 31, -2, 31, 1007, 31, 0, 33,
                           ...
                           65210)])
def test_part1(program, phase_settings, expected):
    assert expected == day7.part1.amplifier(program, phase_settings)
